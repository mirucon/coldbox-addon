...
function cd_addon_czr( $wp_customize ) {
	...
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'no_amp_pages', array(
	...
	$wp_customize->add_setting( 'amp_analytics', array(
		'default'  => '',
		'sanitize_callback' => 'sanitize_text_field',
	));
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'amp_analytics', array(
	...
	$wp_customize->add_setting( 'amp_adsense_client', array(
		'default'  => '',
		'sanitize_callback' => 'sanitize_text_field',
	));
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'amp_adsense_client', array(
	...
	// Adds AdSense settings for AMP pages.
	$wp_customize->add_setting( 'amp_adsense_unit_after', array(
		'default'  => '',
		'sanitize_callback' => 'sanitize_text_field',
	));
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'amp_adsense_unit_after', array(
	...
	// Adds AdSense settings for AMP pages.
	$wp_customize->add_setting( 'amp_adsense_unit_middle', array(
		'default'  => '',
		'sanitize_callback' => 'sanitize_text_field',
	));
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'amp_adsense_unit_middle', array(
